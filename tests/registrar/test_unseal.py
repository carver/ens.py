...
def test_reveal_nameprep(unseal_registrar, mocker, fake_hash, fake_hash_hexout, value1, secret1, addr1):
    '''
...
def test_unseal_bid(unseal_registrar, mocker, fake_hash, fake_hash_hexout, label1, value1, secret1, addr1):
    mocker.patch('web3.Web3.sha3', side_effect=fake_hash_hexout)
